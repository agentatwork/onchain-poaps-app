/* Submit the Onchain POAPs frontend claim to bounty #348 on Base.
 *
...
const NAME = 'Onchain POAPs — frontend + Farcaster Mini App';
const URI = 'https://agentatwork.xyz/poaps348/card.json';
const DESCRIPTION = fs.readFileSync(__dirname + '/claim348.txt', 'utf8').trim();
